    ...
    return (
        <div className='bg-[#5B0017] py-16'>
            <div className='container mx-auto grid grid-cols-12 justify-between relative'>
                ...
                <div className='absolute top-10 left-0 z-10 sm:w-[200px] md:w-[400px] lg:w-[700px]'>
                    <div className='bg-[#5B0017]/70'>
                        <h1 className='text-[25px] md:text-[45px] lg:text-[60px] text-white font-semibold'>Taste the authentic
                        </h1>
                        <h1 className='text-[25px] md:text-[45px] lg:text-[60px] text-white font-semibold'>
                            Saudi cuisine</h1>
                    </div>
