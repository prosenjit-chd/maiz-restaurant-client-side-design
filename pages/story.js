        ...
        <div>
            ...
            <div className='bg-[#CC9D2F]'>
                <div >
                    <div className="container mx-auto py-36">
                        ...
                        <div className="grid grid-cols-2 gap-24">
                            ...
                            <div className="col-span-1 text-justify">
                                <h2 className="text-2xl font-medium mb-4 text-white">One of the best resturants in Saudi Arabia.</h2>
                    ...
                    {/* Year Section */}
                    <div className='bg-[#5B0017] py-36 mx-auto px-24 mb-16 container '>
